    ...
    draw() {
        ...
        if (this.player == 'Left') {
            ...
            switch (this.typeFill) {
                ...
                case 'green':
                    c.drawImage(greenB, 24 + 68 * this.x + 500, 68 * this.y, 68, 68)
                    break
                case 'blue':
                    c.drawImage(blueB, 24 + 68 * this.x + 500, 68 * this.y, 68, 68)
                    break
                case 'red':
                    c.drawImage(redB, 24 + 68 * this.x + 500, 68 * this.y, 68, 68)
                    break
            }
        }
            ...
            for (let i = 0; i < this.array.length; ++i) {
                for (let j = 0; j < this.array[i].length; ++j) {
                    ...
                    if (this.array[i][j].typeFill == 'null') {
                        ...
                        c.drawImage(colorIMG, (24 + 68 * j) + 500, 68 * i, 68, 68)
                    }
...
class Pill {
    ...
    draw() { 
        if (this.player == "Left") {
            ...
            c.drawImage(imgH, 24 + 68 * this.head.x+ 500, 68 * this.head.y, 68, 68)
            c.drawImage(imgT, 24 + 68 * this.tail.x+ 500, 68 * this.tail.y, 68, 68)
